    ...
    <table class="table table-hover" style="text-align: center">
        ...
        @foreach ($books as $book)
            <tr>
                ...
                <td><a href="{{route("books.show",$book)}}" class="btn btn-info btn-simple btn-xs" style='color:#fff; text-decoration: none;'><i class="fa fa-eye" aria-hidden="true" style="color: #212c69"></i></a></td>
                <td><a href="{{route("edit.book",$book)}}" class="btn btn-success btn-simple btn-xs" style='color:#fff; text-decoration: none;'><i class="fa fa-edit"></i></a></td>
                <td>
